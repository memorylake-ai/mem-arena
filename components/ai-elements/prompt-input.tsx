...
/** Attachment file: FileUIPart + id, optional size (from File.size). */
export type AttachmentFile = FileUIPart & { id: string; size?: number };
...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      ...
      .then((convertedFiles: AttachmentFile[]) => {
        try {
          const result = onSubmit({ text, files: convertedFiles }, event);

          // Handle both sync and async onSubmit: clear only after submit actually succeeds
